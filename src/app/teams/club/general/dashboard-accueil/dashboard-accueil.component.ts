...
@Component({
  selector: 'app-dashboard-accueil',
  templateUrl: './dashboard-accueil.component.html',
  styleUrls: ['./dashboard-accueil.component.scss'],
  animations: [
...
export class DashboardAccueilComponent implements OnInit {
